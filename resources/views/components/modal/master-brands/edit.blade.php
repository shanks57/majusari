<div 
    ...
    role="dialog" tabindex="-1" aria-labelledby="edit-modal-label" id="hs-edit-modal-{{ $brand->id }}">
    ...
    <div class="m-3 transition-all ease-out opacity-0 md:ml-auto hs-overlay-open:opacity-100 hs-overlay-open:duration-500 md:max-w-2xl md:w-full">
        <div class="flex flex-col p-6 bg-white shadow-lg pointer-events-auto gap-y-4 rounded-xl">
            <div class="flex items-center justify-between px-4">
                ...
                <button type="button" class="text-red-500" aria-label="Close" data-hs-overlay="#hs-edit-modal-{{ $brand->id }}">
                ...
                <div class="p-4 overflow-y-auto">
                    ...
                    <div class="w-full mb-4">
                        ...
                        <input type="text" id="name" name="name" x-model="form.name"
                            ...
                            placeholder="Masukkan Merek Barang" required maxlength="50">
                    </div>
                    <div class="flex items-center justify-between w-full mb-4">
                        ...
                        <div class="flex items-center mb-4">
                            ...
                            <input type="checkbox" id="status-toggle-{{ $brand->id }}" name="status"
                                x-model="form.status"
