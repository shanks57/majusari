<div id="hs-image-goods-modal-{{ $goodsafe->id }}"
    class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto pointer-events-none"
    role="dialog" tabindex="-1" aria-labelledby="hs-image-goods-modal-{{ $goodsafe->id }}-label">
    <div
        ...
        <div
            ...
            <div class="flex items-center justify-center pb-4 border-b">
                <h3 id="hs-image-goods-modal-{{ $goodsafe->id }}-label" class="text-xl font-semibold text-[#344054]">
                    Tampilan Penuh Etalase
                </h3>
            </div>
            <div class="flex justify-center">
                <img src="{{ asset('storage/' . $goodsafe->image) }}" class="rounded size-80"
                    alt="{{ $goodsafe->name }}">
            </div>
