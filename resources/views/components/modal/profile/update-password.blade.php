    <div x-data="{ 
        ...
        role="dialog" tabindex="-1" aria-labelledby="update-password-modal"
        id="hs-update-password-modal">
        ...
        <div
            ...
            <div class="flex flex-col p-6 bg-white shadow-lg pointer-events-auto gap-y-4 rounded-xl">
                ...
                <form :action="`{{ route('profile.set-password', Auth::user()->id) }}`" method="post">
                    @csrf
                    @method('PUT')
