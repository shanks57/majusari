...
<x-layout>
    ...
    <div class="container py-4 mx-auto">
        ...
        <div class="inline-flex justify-center w-full mx-auto rounded-md" role="group">
            <a href="{{ route('master.showcase.export-pdf') }}" class="p-3 font-normal text-white bg-gray-400 rounded-s-xl hover:bg-gray-500 focus:z-10 focus:ring-1 focus:ring-gray-500">
                PDF
            </a>
            <a href="{{ route('master.showcase.export-excel') }}" class="px-2.5 py-3 font-normal text-white bg-gray-400 hover:bg-gray-500 focus:z-10 focus:ring-1 focus:ring-gray-500">
                Excel
            </a>
            <a href="{{ route('master.showcase.print') }}" class="p-3 font-normal text-white bg-gray-400 rounded-e-xl hover:bg-gray-500 focus:z-10 focus:ring-1 focus:ring-gray-500">
                Print
            </a>
        </div>
