<x-layout>
    ...
    <div x-data="{ isEdit: false }" class="grid grid-cols-3 mt-5">
        <div class="rounded-xl border p-3 bg-white flex flex-col gap-3 justify-center items-center">
            ...
            <div class="bg-gray-50 border px-6 py-2 w-full">
                ...
                <input x-bind:disabled="isEdit" type="text" class="bg-transparent outline-none"
                    value="Saputra Budi Utama">
            </div>
            <div class="bg-gray-50 border px-6 py-2 w-full">
                <label class="block mb-1" for="email">Email</label>
                <input x-bind:disabled="isEdit" type="text" class="bg-transparent outline-none"
                    value="andikawijaya@gmail.com">
            </div>
            <div class="bg-gray-50 border px-6 py-2 w-full">
            ...
            <div class="flex justify-center gap-4">
                <button @click="isEdit = !isEdit"
                    class="bg-purple-700 text-white px-4 py-2 rounded-lg flex items-center gap-2">
                    Ubah Profil
