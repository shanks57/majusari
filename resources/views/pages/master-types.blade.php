                ...
                <tbody class="text-sm font-light text-gray-600">
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="px-6 py-3 text-center">
                            ...
                            <button class="px-3 py-1 text-white bg-red-500 rounded" aria-haspopup="dialog"
                                aria-expanded="false" aria-controls="hs-delete-modal-{{ $type->id }}"
                                data-hs-overlay="#hs-delete-modal-{{ $type->id }}">
                                <i class="ph ph-trash"></i> Hapus</button>
                        </td>
                    </tr>
                    @include('components.modal.master-types.edit')
                    @include('components.modal.master-types.delete')
                    @endforeach
                </tbody>
            </table>
        </div>
