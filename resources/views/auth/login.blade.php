        ...
        <div class="max-w-md mx-auto">
            ...
            <form method="POST" action="{{ url('login') }}">
                ...
                <div class="mb-4">
                    ...
                    <input name="email" class="w-full px-3 py-3 text-sm leading-tight text-gray-700 border border-gray-400 rounded-lg outline-none appearance-none focus:outline-none focus:shadow-outline" id="email" type="email" placeholder="Masukkan email" />
                </div>
                <div class="mb-6" x-data="{ show: false }">
                    <label class="block mb-2 text-sm font-bold text-gray-700" for="password">Password</label>
                    <div class="relative">
                        <input :type="show ? 'text' : 'password'" name="password" class="w-full px-3 py-3 text-sm leading-tight text-gray-700 border border-gray-400 rounded-lg outline-none appearance-none focus:outline-none focus:shadow-outline" id="password" placeholder="Masukkan Password" />
                ...
                <div class="mb-6">
                    <button type="submit" class="w-full px-4 py-2 font-bold text-white bg-purple-500 rounded disabled:bg-gray-300 focus:outline-none focus:shadow-outline hover:bg-purple-600" type="button">
                        Masuk
                    </button>
                </div>
            </form>
